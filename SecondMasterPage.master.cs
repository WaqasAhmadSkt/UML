...
public partial class SecondMasterPage : System.Web.UI.MasterPage
{
    ...
    protected void btn_Add_New_Entity_Click(object sender, EventArgs e)
    {
        Response.Redirect("addnewentity.aspx");
    }
    protected void btn_Add_Relationships_Click(object sender, EventArgs e)
    {
        Response.Redirect("entitybehaviorrelationship.aspx");
    }
    protected void btn_UML_Click(object sender, EventArgs e)
    {
        Response.Redirect("showUMLdiagramsbtn.aspx");
    }
    protected void btn_Source_Code_Click(object sender, EventArgs e)
    {
        Response.Redirect("CreateSqlTables.aspx");
    }
}
